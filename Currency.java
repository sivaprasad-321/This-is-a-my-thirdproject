...
public class Currency {
	...
	public void defaultValues() {
		...
		switch (currency) {	
			case "US Dollar":
				...
				this.exchangeValues.put("IND",8097.97);
				break;
			case "Euro":
				...
				this.exchangeValues.put("IND",0.97);
				break;
			case "British Pound":
				...
				this.exchangeValues.put("IND",689.97);
				break;
			case "Swiss Franc":
				...
				this.exchangeValues.put("IND",5.97);
				break;
			case "Chinese Yuan Renminbi":
				...
				this.exchangeValues.put("IND",2.97);
				break;
			case "Japanese Yen":
				...
				this.exchangeValues.put("IND",8.97);
				break;
			case "Bharath IND":
				this.exchangeValues.put("USD",0.87);
				this.exchangeValues.put("EUR",0.97);
				this.exchangeValues.put("GBP",1.9);
				this.exchangeValues.put("CHF",5.00);
				this.exchangeValues.put("CNY",7.0);
				this.exchangeValues.put("JPY",16.0);
				this.exchangeValues.put("IND",1.0);
	...
	public static ArrayList<Currency> init() {   
		...
		currencies.add( new Currency("Bharath IND","IND") );
